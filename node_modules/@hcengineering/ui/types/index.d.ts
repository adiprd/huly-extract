...
export * from './lazy';
export * from './stores';
export declare function createApp(target: HTMLElement): SvelteComponent;
export declare const ticker: import("svelte/store").Readable<number>;
export declare const deviceOptionsStore: import("svelte/store").Writable<DeviceOptions>;
export default uis;

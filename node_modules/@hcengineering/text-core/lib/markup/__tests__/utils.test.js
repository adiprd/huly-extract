...
describe("hashAttrs", () => {
  it("should return a hash of length 8", () => {
    const attrs = { a: 1 };
    const hash = (0, import_utils.hashAttrs)(attrs);
    expect(hash.length).toEqual(8);
  });
  it("should return the same hash for the same attrs", () => {
    const attrs = { a: 1, b: 2 };
    const hash1 = (0, import_utils.hashAttrs)(attrs);
    const hash2 = (0, import_utils.hashAttrs)(attrs);
    expect(hash1).toEqual(hash2);
  });
  it("should return different hashes for different attrs", () => {
    const attrs1 = { a: 1, b: 2 };
    const attrs2 = { a: 1, b: 3 };
    const hash1 = (0, import_utils.hashAttrs)(attrs1);
    const hash2 = (0, import_utils.hashAttrs)(attrs2);
...
describe("stripHash", () => {
  it("should return the name without the hash", () => {
    ...
    const result = (0, import_utils.stripHash)(name);
